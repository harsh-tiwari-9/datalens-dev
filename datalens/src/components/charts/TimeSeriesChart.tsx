    ...
    <div className={`space-y-4 ${className}`}>
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            {!title && <h3 className="font-semibold text-slate-900 dark:text-slate-100">Time Series</h3>}
      ...
      <div className="relative h-40 bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-800 dark:to-slate-900 rounded-xl p-4 border border-slate-200 dark:border-slate-700">
        <svg className="w-full h-full" viewBox="0 0 300 120">
          <defs>
            <linearGradient id="timeSeriesGradient" x1="0%" y1="0%" x2="100%" y2="0%">
              <stop offset="0%" stopColor="#10b981" stopOpacity="0.8"/>
              <stop offset="50%" stopColor="#06b6d4" stopOpacity="0.6"/>
              <stop offset="100%" stopColor="#3b82f6" stopOpacity="0.4"/>
            </linearGradient>
            <linearGradient id="timeSeriesArea" x1="0%" y1="0%" x2="0%" y2="100%">
              <stop offset="0%" stopColor="#10b981" stopOpacity="0.3"/>
              <stop offset="100%" stopColor="#10b981" stopOpacity="0.05"/>
            </linearGradient>
            <filter id="timeSeriesGlow">
          ...
          <path
            d={generatePath()}
            stroke="url(#timeSeriesGradient)"
            strokeWidth="3"
            fill="none"
            filter="url(#timeSeriesGlow)"
