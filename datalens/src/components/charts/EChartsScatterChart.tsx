...
interface EChartsScatterChartProps extends ChartProps {
  showGrid?: boolean
  showLabels?: boolean
  maxBubbles?: number
...
export const EChartsScatterChart: React.FC<EChartsScatterChartProps> = ({
  ...
  const optimizedData = useMemo(() => {
    if (values.length > maxBubbles) {
      console.warn(`Large dataset detected (${values.length} points). Sampling to ${maxBubbles} points for performance.`)
  ...
  }, [scatterData, title, subtitle, theme, showGrid])
